  ...
  return (
    ...
    >
      ...
      <div className={`flex justify-between items-center`}>
        <Link
          to={"/"}
          className="flex hover:text-gray-500 hover:font-bold mx-2 px-2 py-1 items-center   justify-start"
        >
          <FaIndustry size={20} />
      ...
      {actionList[3] && (
        <motion.div initial = {{ height:0, opacity:0}} animate={{height: actionList[3] ? "auto" : 0, opacity:1}} transition={{duration:0.4}} className={`flex flex-col mx-3 ${themeColor()}`}>
          ...
          <NavLink
            ...
            className="flex hover:text-gray-500 hover:font-bold  py-1 items-center   justify-start"
          >
            <BsArrowRight size={15} />
            <h1 className="mt-1 ml-5 text-sm">
      ...
      <motion.div initial = {{ height:0, opacity:0}} animate={{height: actionList[4] ? "auto" : 0, opacity:1}} transition={{duration:0.4}}  className='flex flex-col mx-4'>
        ...
        <Link to={"/"} className={`flex hover:text-gray-500 ${themeColor()} hover:font-bold  py-1 items-center   justify-start`}>
          <BsArrowRight size={15} />
          <h1 className="mt-1 ml-5 text-sm">List Sell Return</h1>
        </Link>
        ...
        {/* <Link to={"/"} className={`flex hover:text-gray-500 ${themeColor()} hover:font-bold  py-1 items-center   justify-start`}>
          <BsArrowRight size={15} />
          <h1 className="mt-1 ml-5 text-sm">Subscriptions</h1>
        </Link> */}
        <NavLink to={"/home/import-sales"} className={`flex hover:text-gray-500 hover:font-bold  aria-[current=page]:${activeColor()}  py-1 items-center ${themeColor()}   justify-start`}>
          <BsArrowRight size={15} />
          <h1 className="mt-1 ml-5 text-sm">Import Sales</h1>
        </NavLink>
      </motion.div>
      }
      ...
      {actionList[9] && (
        <motion.div initial = {{ height:0, opacity:0}} animate={{height: actionList[9] ? "auto" : 0, opacity:1}} transition={{duration:0.4}} className={`flex flex-col mx-3 ${themeColor()}`}>
          <NavLink
          ...
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Tax Report</h1>
          </NavLink>
          {/* <Link
            to={"/"}
            className="flex hover:text-gray-500 hover:font-bold  py-1 items-center   justify-start"
          ...
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Stock Report</h1>
          </NavLink>
          {/* <Link
            to={"/"}
            className="flex hover:text-gray-500 hover:font-bold  py-1 items-center   justify-start"
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Lot Report</h1>
          </Link> */}
          <NavLink
          ...
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Items Report</h1>
          </NavLink>
          <NavLink
          ...
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Table Report</h1>
          </Link> */}
          {/* <Link
            to={"/"}
            className="flex hover:text-gray-500 hover:font-bold  py-1 items-center   justify-start"
          ...
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Activity Log</h1>
          </NavLink>
        </motion.div>
      )}
      {/* Booking */}
      ...
      {actionList[10] && (
        <motion.div initial = {{ height:0, opacity:0}} animate={{height: actionList[10] ? "auto" : 0, opacity:1}} transition={{duration:0.4}} className={`flex flex-col mx-3 ${themeColor()}`}>
          ...
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Tax Rates</h1>
          </Link>
          <Link
            to={"/"}
            className="flex hover:text-gray-500 hover:font-bold  py-1 items-center   justify-start"
          >
            <BsArrowRight size={15} />
            <h1 className=" mt-1 ml-5 text-sm ">Tables</h1>
          </Link>
          <Link
            to={"/"}
            className="flex hover:text-gray-500 hover:font-bold  py-1 items-center   justify-start"
