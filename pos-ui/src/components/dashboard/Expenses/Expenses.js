...
import Expensestbl from "../Tables/Expensestbl";
        ...
        {isFilter && (
          <div className=" grid grid-cols-1 bg-white rounded-md gap-5 md:grid-cols-4 mt-5 w-full">
            <div className="flex flex-col">
              <h1 className="text-start font-bold text-xs">
                Business Location:
              </h1>
              <select
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col relative">
                <div className="flex">
                  ...
                  <BiChevronDown
                    size={20}
                    className={`${open && "rotate-180"} absolute top-3 right-4`}
                  />
                </div>
                {open && (
                  <ul
                    className={`bg-white z-10  w-[250px] -right-8 mx-[30px] border-[1px] absolute top-9 border-gray-600 overflow-y-auto ${
            ...
            <div className="flex flex-col">
              <h1 className="text-start font-bold">Contact:</h1>
              <select
              ...
              >
                {dummyData?.map((data) => (
                  <option key={data.contact} value={data.contact}>
                    {data.contact}
                  </option>
                ))}
              </select>
            ...
            <div className="flex flex-col">
              <h1 className="text-start font-bold">Expense Category:</h1>
              <select
              ...
              >
                ...
                <option value={"Test Expense"}>Test Expense</option>
            ...
            <div className="flex flex-col relative">
              <h1 className="text-sm font-semibold text-start mb-2">
                Date Range:
              </h1>
              <input
